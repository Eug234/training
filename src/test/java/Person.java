...
//Клас Person
//a)поля fullName, age.б)методи move() і talk(), у яких просто виводить в консоль
//повідомлення -"Person рухається"i "Person говорить".в) Додайте два конструктори - Person() та Person(fullName, age).
