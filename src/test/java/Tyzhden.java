...
@Test
public class Tyzhden {
//if-else конструкція
//1. Написати метод який буде виводити назву тижня в залежності від введеного числа.
//Відповідно 1 - Понеділок, 2 - Вівторок, 3 - Середа, 4 - Четвер, 5 - П'ятниця, 6,7 - Вихідний.
// Опрацювати варіант, коли число не відповідає дню неділі.
...
//цикл for
//3. Написати метод, що буде виводити в консоль, числа (в проміжу від 1 до 100) кратні умовному 2
